package com.github.dapitmusic.visualizer;
...
import com.github.dapitmusic.equalizer.Settings;
...
public class VisualizerView extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		if (Settings.isPlayerVisible) {
			if (EqualizerActivity.mVisualizerView != null
					&& (EqualizerActivity.mVisualizerView.getVisibility() == View.VISIBLE)) {
				if (bmp != null)
