...
import com.github.dapitmusic.listener.AlbumSelectListener;
...
public class AlbumsAdapter extends RecyclerView.Adapter<AlbumsAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.albumDetails.setText(String.format(Locale.getDefault(), "%s - %s - %d Lagu",
        ...
        if (holder.state)
            Glide.with(holder.albumArt.getContext())
                    ...
                    .placeholder(R.drawable.ic_notif_music_note)
