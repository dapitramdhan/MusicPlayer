package com.github.dapitmusic.player;

import static com.github.dapitmusic.MPConstants.AUDIO_FOCUSED;
import static com.github.dapitmusic.MPConstants.AUDIO_NO_FOCUS_CAN_DUCK;
import static com.github.dapitmusic.MPConstants.AUDIO_NO_FOCUS_NO_DUCK;
import static com.github.dapitmusic.MPConstants.NEXT_ACTION;
import static com.github.dapitmusic.MPConstants.NOTIFICATION_ID;
import static com.github.dapitmusic.MPConstants.PLAY_PAUSE_ACTION;
import static com.github.dapitmusic.MPConstants.PREV_ACTION;
import static com.github.dapitmusic.MPConstants.VOLUME_DUCK;
import static com.github.dapitmusic.MPConstants.VOLUME_NORMAL;
...
public class PlayerManager implements MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener,
	...
	private final AudioManager.OnAudioFocusChangeListener audioFocusChangeListener = new AudioManager.OnAudioFocusChangeListener() {
		...
		public void onAudioFocusChange(final int focusChange) {
			...
			case AudioManager.AUDIOFOCUS_LOSS_TRANSIENT:
				...
				playOnFocusGain = isMediaPlayer() && playerState == PlaybackStateCompat.STATE_PLAYING
	...
	private void setPlayerState(@PlayerListener.State int state) {
		...
		playerService.getMediaSessionCompat()
				.setPlaybackState(new PlaybackStateCompat.Builder()
						...
						.setState(playbackState, mediaPlayer.getCurrentPosition(), 0).build());
	}
	...
	private void tryToGetAudioFocus() {
		final int result = audioManager.requestAudioFocus(audioFocusChangeListener, AudioManager.STREAM_MUSIC,
