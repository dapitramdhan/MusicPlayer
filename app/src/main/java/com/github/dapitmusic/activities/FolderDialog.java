...
import com.github.dapitmusic.App;
...
public class FolderDialog extends BottomSheetDialog {
	...
	public FolderDialog(@NonNull Context context, List<Folder> folderList) {
		...
		FolderAdapter adapter = new FolderAdapter(folderList, exclusionFolders,
				new FolderAdapter.FolderExclusionListListener() {
					@Override
	...
	static class FolderAdapter extends RecyclerView.Adapter<FolderAdapter.MyViewHolder> {
		...
		public FolderAdapter(List<Folder> folderList, List<String> exclusionList,
				FolderExclusionListListener listener) {
